...
class homeControllers{
    ...
    query_products = async(req,res) => {
        ...
        try {
            ...
            .categoryQuery().ratingQuery().searchQuery().priceQuery().sortByPrice().countProducts()

            const result = new queryProducts(products, req.query)
            .categoryQuery().ratingQuery().priceQuery().searchQuery().sortByPrice().skip().limit().getProducts()
    ...
    submit_review = async(req,res) => {
        ...
        try {
            ...
            responseReturn(res,201,{message: 'Review Add Successfully'})
        } catch (error) {
            console.log(error.message)
        }
    }
