    ...
    place_order = async (req,res) => {
        ...
        for (let i = 0; i < products.length; i++) {
            ...
            for (let j = 0; j < pro.length; j++) {
                const tempCurPro = pro[j].productInfo;
                tempCurPro.quantity = pro[j].quantity
                customerOrderProduct.push(tempCurPro)
                if (pro[j]._id) {
        ...
        try {
            ...
            responseReturn(res,200,{message: 'Order Place Success', orderId: order.id})
